...
for (let i = 0; i < cantidadClientes; i++) {
    ...
    const nombreCliente = clientes[i].nombre;
    const horasAlquiler = clientes[i].horas;
    ...
    const mensajeDescuento = horasAlquiler > horasDescuento ? "CON DESCUENTO" : "SIN DESCUENTO";
